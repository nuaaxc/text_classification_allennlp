...
class TripletLoss(object):
    ...
    def __init__(self, labels, embeddings, margin, squared=False, cuda_device=0):
        self.labels = labels
    ...
    def batch_hard_triplet_loss(self):
        ...
        mask_anchor_positive = self._get_anchor_positive_triplet_mask().float()
    ...
    def _get_anchor_positive_triplet_mask(self):
        ...
        indices_equal = torch.eye(self.labels.size(0)).byte().to(self.device)
